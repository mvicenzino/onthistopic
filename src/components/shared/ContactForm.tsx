...
const inputClasses =
  'w-full rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm text-gray-900 placeholder:text-gray-400 transition-colors focus:border-navy focus:outline-none focus:ring-1 focus:ring-navy/20'
...
export function ContactForm({ variant = 'compact' }: ContactFormProps) {
  ...
  if (submitted) {
    return (
      <div className="rounded-xl bg-cream-dark border border-black/5 p-8 text-center">
